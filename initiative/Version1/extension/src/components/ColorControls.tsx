...
export default function ColorControls({ onShadowSettingsChange, onBuildingColorsChange }: ColorControlsProps) {
  ...
  const [contextBuildingColor, setContextBuildingColor] = useState("#d0d0d0");
  ...
  const [terrainColor, setTerrainColor] = useState("#e8e8e8");

  const [contextShadowEnabled, setContextShadowEnabled] = useState(false);
  const [contextShadowColor, setContextShadowColor] = useState("#999999");
  const [designShadowEnabled, setDesignShadowEnabled] = useState(false);
  const [designShadowColor, setDesignShadowColor] = useState("#3366cc");
